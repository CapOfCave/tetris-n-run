...
public class MenuPanel extends JPanel implements Playable {
	...
	public void paintComponent(Graphics g) {
		...
		if (menuFrame.isLoading()) {
			...
			g.drawImage(menuTitel, 245 * menuFrame.getPanelWidth() / 1920, 81 * menuFrame.getPanelHeight() / 1080, null);
	...
	public void drawLoadingScreen(Graphics g) {
		...
		g.drawImage(loadingAnim.getImage(), menuFrame.getPanelWidth()/2 - loadingAnim.getImage().getWidth()/2, menuFrame.getPanelHeight()/2 - loadingAnim.getImage().getHeight()/2, null); // TODO bounz
		loadingAnim.next();
